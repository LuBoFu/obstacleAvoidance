...
# 以下是和具体任务相关的内容
set targetDirectory /sw/obstacleAvoidance/kittiDepthToPointCloudMap/generateDepthHDF5

# create directories on sw machine.
$sshCommand zb@$serverName mkdir -p  $targetDirectory/bin
$sshCommand zb@$serverName mkdir -p  $targetDirectory/inputData

# copy binaries and associated files to sw machine.
$scpCommand  bin/generateDepthHDF5   zb@$serverName:$targetDirectory/bin
$scpCommand  inputData/*   zb@$serverName:$targetDirectory/inputData
