...
# 以下是和具体任务相关的内容
set targetDirectory /sw/obstacleAvoidance/personDetection
...
$sshCommand zb@$serverName mkdir -p  $targetDirectory/model
$sshCommand zb@$serverName mkdir -p  $targetDirectory/samples
...
# $scpCommand  samples/*   zb@$serverName:$targetDirectory/samples
# $scpCommand  model/*     zb@$serverName:$targetDirectory/model
